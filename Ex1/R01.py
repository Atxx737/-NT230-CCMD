...
try:
    ...
    print("newEntryPoint",hex(newEntryPoint))
    print("newRawOffset",hex(newRawOffset))
except:
...
# https://github.com/J3736/NT230_Ex01
# https://github.com/shjn3/NT230.M21.ANTT
# Chân thành cảm ơn sự giúp đỡ từ các bạn trong lớp, mặc dù em copy bài nhưng em có sự cảm ơn sâu sắc tới mọi người
# Chân thành cảm ơn nhóm anh/ bạn Ngô Khoa đã up bài lên cho em coi và làm theo
